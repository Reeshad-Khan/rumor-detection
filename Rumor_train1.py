...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs, LR_RATE, BATCH_SIZE, L_MODEL, DATA_MODE, SEQ_MODE, device):
...
if __name__ == "__main__":
    ...
    # Train the model
    train_model(model, train_loader, val_loader, criterion, optimizer, NUM_EPOCHS, LR_RATE, BATCH_SIZE, L_MODEL, DATA_MODE, SEQ_MODE, device)
