...
if __name__ == "__main__":
    ...
    #best_model_pth = './Best_Model/src_twt_all_replies/bert/1best_model_70epochs_3e-05lrate_16batch-size.pth'
    #best_model_pth = './Best_Model/src_twt_all_replies/roberta/1best_model_70epochs_3e-05lrate_16batch-size.pth'
    ...
    test_dataset = RumorDataset(test_texts, test_labels, tokenizer, MAX_LENGTH,L_MODEL)
